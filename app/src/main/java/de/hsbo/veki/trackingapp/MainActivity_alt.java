...
public class MainActivity_alt extends AppCompatActivity implements LocationListener, ResultCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set Context
        MainActivity_alt.setContext(this);
...
//
        ...
        {
            localGeodatabase.getOfflineFeatureLayer();
            ...
            geodatabaseFeatureTable = localGeodatabase.getGeodatabaseFeatureTable();
        ...
        mMapView.setOnSingleTapListener(new
                                                ...
                                                OnSingleTapListener() {
                                                    ...
                                                    private View loadView(String id, String username, String vehicle, Long date) {
                                                        View view = LayoutInflater.from(MainActivity_alt.this).inflate(R.layout.pointinfo, null);
...
//                    }
    ...
    public void onLocationChanged(Location location) {
        ...
        try {
            localGeodatabase.addFeature(attributes, mLocation);
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     * @param message
     */
    protected static void showProgressBar(final MainActivity_alt activity, final String message) {
    ...
    public void showToast(final String message) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MainActivity_alt.this, message, Toast.LENGTH_SHORT).show();
            }
        });
    }
